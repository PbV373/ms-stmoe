...
from ms_stmoe_chla.moe_layers import Experts, Expert
from ms_stmoe_chla.distributed import all_gather_variable_dim
...
def start(
    ...
    if rank == 0:
        ...
        print('鉁?outputs and gradients are same between local and ddp')
